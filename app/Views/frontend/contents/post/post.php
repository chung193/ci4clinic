   ...
   <section class="main-title-section-wrapper default" style="background:url(https://dtdental.wpenginepowered.com/wp-content/uploads/2015/06/breadcrumb-bg.jpg) center center no-repeat;">
      <div class="container">
         ...
         <div class="breadcrumb">
            ...
            <a href="<?= base_url().'/danh-muc/'.$post->catslug ?>"><?= $post->cattitle ?> <span class="fa default"></span></a>
            
            <a href="<?= base_url().'/bai-viet/'.$post->slug ?>"><?= $post->title ?></a>
         </div>
      </div>
   </section>
   <div class="container">
      <section id="primary" class="content-full-width">
         <article id="post-1" class="blog-entry single entry-default post-1 post type-post status-publish format-standard has-post-thumbnail hentry category-news category-technical tag-blog">
            ...
            <div class="entry-thumb">
               <a href="https://dtdental.wpengine.com/integer-at-diam-gravida-fringilla-nibh-preti-purus/" title="Permalink to Painless Dental Procedures">
                  <img width="1170" height="795" src="<?= base_url() . '/public/uploads/post/' . $post->img ?>" class="attachment-full size-full wp-post-image" alt="" 
                  srcset="<?= base_url() . '/public/uploads/post/' . $post->img ?> 1170w, <?= base_url() . '/public/uploads/post/' . $post->img ?> 300w, <?= base_url() . '/public/uploads/post/' . $post->img ?> 1024w" sizes="(max-width: 1170px) 100vw, 1170px"></a>
               <div class="entry-format ">
                  <a class="ico-format" href=""></a>
               </div>
               <?php 
                  $d = strtotime($post->createdat);
               ?>
