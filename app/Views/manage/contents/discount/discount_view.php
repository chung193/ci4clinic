    ...
    <table id="example2" class="table table-bordered table-striped dataTable dtr-inline">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $row['money']?></td>
                <td>
                    <a class="text-info" href="<?php echo base_url()?>/manage/discount/edit/<?= $row['id'];?>">Sửa</a>
                    <a class="text-danger" href="<?php echo base_url()?>/manage/discount/delete/<?= $row['id'];?>">Xóa</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
