<div class="content-wrapper" style="min-height: 1345.6px">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Thêm mới địa chỉ chi nhánh</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url() . '/manage/dashboard' ?>">Trang chủ</a></li>
                        <li class="breadcrumb-item active">Thêm mới địa chỉ chi nhánh</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline card-outline-tabs">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo base_url() ?>/manage/location/save" method="post" enctype='multipart/form-data'>
