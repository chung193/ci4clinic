...
<section class="content">
    ...
    <?php endif;?>
    <form action="<?php echo base_url()?>/manage/shop-slider/save" method="post" enctype='multipart/form-data'>
        <div class="mb-3">
            <label for="title" class="form-label">Tiêu đề</label>
            <input type="text" id="title" class="form-control" name="main_title" placeholder="Tiêu đề chính">
        </div>
        <div class="mb-3">
            <label for="title" class="form-label">Tiêu đề phụ</label>
            <input type="text" class="form-control" name="sub_title" placeholder="Tiêu đề phụ">
        </div>
