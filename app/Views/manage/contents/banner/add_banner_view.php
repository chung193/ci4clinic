...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Thêm mới banner quảng cáo</h1>
          </div>
          <div class="col-sm-6">
...
<section class="content">
    ...
    <?php endif;?>
    <form action="<?php echo base_url()?>/manage/banner/save" method="post" enctype='multipart/form-data'>
        <div class="mb-3">
            <label for="title" class="form-label">Tiêu đề chính</label>
            <input type="text" id="title" class="form-control" name="text_main" placeholder="tiêu đề chính">
        </div>
        <div class="mb-3">
            <label for="title" class="form-label">Tiêu đề phụ</label>
            <input type="text" class="form-control" name="text_sub" placeholder="Tiêu đề phụ">
        </div>
