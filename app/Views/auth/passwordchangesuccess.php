...
<html lang="vi">
  <head>
    ...
    <title>Bạn đã đổi mật khẩu thành công</title>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Mật khẩu đã được thay đổi</p>
      <p>Mật khẩu đã được thay đổi thành công</p>
      <p><a href="<?php echo base_url()?>/auth/login">Trở lại trang đăng nhập</a></p>
